...
```{r always-loses, message = FALSE, echo = FALSE, fig.width = 3.5, fig.height = 3.5, fig.show = "hold", out.width = "300px", echo = FALSE}
par(mar = rep(1, 4))
library(igraph)
R <- matrix(c(1, 2, 0, 0,
              2, 0, 1, 0,
...
```{r disconnected, message = FALSE, echo = FALSE, fig.width = 3.5, fig.height = 3.5, fig.show = "hold", out.width = "300px", echo = FALSE}
par(mar = rep(1, 4))
...
```{r pseudo-rankings, fig.width = 3.5, fig.height = 3.5, echo = FALSE}
par(mar = rep(1, 4))

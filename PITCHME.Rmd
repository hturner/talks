...
# so R comments also treated as R code 
# (and highlighted as a comment!)               
...
```{r pltree, message = FALSE, fig.width = 10, echo = FALSE, fig.cap = "Item worth estimates within each node of the Plackett-Luce tree.", fig.show="hide"}
